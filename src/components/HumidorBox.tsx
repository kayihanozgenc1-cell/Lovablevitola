...
/** Visual cigar stick colors based on wrapper type */
...
export function HumidorBox({ cigars, onCigarClick, onRemove }: HumidorBoxProps) {
  const maxSlots = 20;
  const emptySlots = Math.max(0, Math.min(maxSlots, 10) - cigars.length);
